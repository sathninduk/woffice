...
$options = array(
	...
	'file_away_info' => array(
	    ...
	    'html' => __('If you need more options about this, please use the default shortcode generator from the plugin, it is slower but you\'ll find more options. You can also have  a look on this article for more details', 'woffice'). '<a href="https://alkaweb.atlassian.net/wiki/spaces/WOF/pages/4194505/File+Away" target="_blank">https://alkaweb.atlassian.net/wiki/spaces/WOF/pages/4194505/File+Away</a>',
	),
);