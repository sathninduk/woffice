			...
			'menu-box' => array(
				...
				'options' => array(
					...
					'menu_hover' => array(
						...
						'desc' => __('Used as a link background, link color on it is the Menu color #2.','woffice')
					),
					'menu_layout'    => array(
						'label' => __( 'Menu Layout', 'woffice' ),
						'desc'  => __( 'Choose your menu layout below. The vertical menu is a beta feature you can try it but we think it needs more options, if you see any bug please report it on alkaweb.ticksy.com', 'woffice' ),
						'type'         => 'switch',
						'right-choice' => array(
							'value' => 'horizontal',
