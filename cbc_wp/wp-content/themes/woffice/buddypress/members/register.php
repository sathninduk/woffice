	...
	<div class="intern-padding clearfix" data-template="woffice">
		...
		<div id="register-page" class="page register-page">
			...
			<form action="" name="signup_form" id="signup-form" class="standard-form signup-form clearfix" method="post" enctype="multipart/form-data">
				...
				<div class="layout-wrap mt-5" data-template="woffice">
					...
					<?php if ( 'request-details' === bp_get_current_signup_step() ) : ?>
						...
						<div class="register-section default-profile" id="basic-details-section">
							...
							<h2 class="bp-heading"><?php esc_html_e( 'Account Details', 'woffice' ); ?></h2>
						...
						<?php if ( bp_is_active( 'xprofile' ) && bp_nouveau_has_signup_xprofile_fields(true) ) : ?>
							...
							<div class="register-section extended-profile" id="profile-details-section">
								...
								<h2 class="bp-heading"><?php esc_html_e( 'Profile Details', 'woffice' ); ?></h2>
						...
						<?php if ( bp_get_blog_signup_allowed() ) : ?>
							...
							<div class="register-section blog-details" id="blog-details-section">
								...
								<h2><?php esc_html_e( 'Site Details', 'woffice' ); ?></h2>

								<p><label for="signup_with_blog"><input type="checkbox" name="signup_with_blog" id="signup_with_blog" value="1" <?php checked( (int) bp_get_signup_with_blog_value(), 1 ); ?>/> <?php esc_html_e( "Yes, i'd like to create a new site", 'woffice' ); ?></label></p>
